...
-   Options:
    ...
    -   Data larger than can be uploaded to container: (Maybe) Adding to the container directly (via OIT)

    -   Data too large for Github, but not too large to be uploaded to container: `gitignore`ing and adding to each container individually
